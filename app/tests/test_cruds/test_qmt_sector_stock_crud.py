...
class TestQmtSectorStockCrud(unittest.TestCase):
    ...
    def test_create_and_get_and_update_qmt_sector_stock(self):
        ...
        print(f"创建的成分股ID: {created_stock.id}, 板块ID: {created_stock.sector_id}, 股票代码: {created_stock.stock_code}")
        ...
        print(f"查询到的成分股ID: {found_stock.id}, 股票代码: {found_stock.stock_code}")
        ...
        print(f"更新前的成分股ID: {found_stock.id}, 旧代码: {found_stock.stock_code}")
        ...
        print(f"更新后的成分股ID: {found_new.id}, 新代码: {found_new.stock_code}")
